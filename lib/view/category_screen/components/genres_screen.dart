        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(child: Container(child: Text("Adventure",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              ...
              Tab(child: Container(child: Text("Shounen",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("Slice Of Life",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("School Life",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("RomanceL",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("Tragedy",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("Historical",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
              Tab(child: Container(child: Text("Martial Arts",style: TextStyle(color: Colors.grey,fontSize: 10),),),),
